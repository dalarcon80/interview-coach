...
function App() {
  ...
  const handleGetSuggestions = useCallback(async () => {
    ...
    try {
      ...
      const response = await api.suggest({
        question: "", // Backend gets question from conversation history when session_id is provided
      ...
      setLiveError(error instanceof Error ? error.message : 'Failed to get suggestions');
    } finally {
