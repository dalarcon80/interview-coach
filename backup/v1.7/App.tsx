                      ...
                      <CardContent className="space-y-3 text-sm">
                        ...
                        {!liveSession.sessionId ? (
                          ...
                          <>
                            ...
                            {debugInfo && (
                              <div className="mt-3 rounded-md border border-warning-300 bg-warning-50 p-3">
                                <div className="flex items-center gap-2 mb-2">
                                  <Bug className="h-4 w-4 text-warning-600" />
                                  <span className="text-xs font-bold text-warning-700 uppercase">Debug: What was sent to coach</span>
                                </div>
                                <div className="space-y-2 text-xs">
                                    ...
                                    return (
                                      <>
                                        ...
                                        {history && history.length > 0 && (
                                          <div className="rounded bg-white border border-warning-200">
                                            <div className="p-2 bg-warning-100 font-semibold text-warning-800">
                                              📋 Questions/Messages Sent to Coach ({history.length}):
                                            </div>
                                            <div className="max-h-48 overflow-y-auto p-2 space-y-2">
                                              {history.map((msg, idx) => (
                                                <div key={idx} className="border-l-2 border-warning-300 pl-2">
                                                  <span className={msg.speaker === 'interviewer' ? 'text-primary-600 font-bold' : 'text-accent-600 font-bold'}>
                                                    {msg.speaker?.toUpperCase() || 'UNKNOWN'}:
                                                  </span>
                                                  <p className="text-surface-700 mt-0.5">{msg.text}</p>
                                                </div>
                                              ))}
                                            </div>
                                          </div>
                                  ...
                                  <details className="rounded bg-white">
                                    <summary className="cursor-pointer p-2 font-semibold text-warning-800 hover:bg-warning-100">View Full Request JSON</summary>
                                    <pre className="max-h-40 overflow-auto p-2 text-[10px] bg-surface-100">
                                  ...
                                  {debugInfo.response && (
                                    <details className="rounded bg-white">
                                      <summary className="cursor-pointer p-2 font-semibold text-warning-800 hover:bg-warning-100">View Full Response JSON</summary>
                                      <pre className="max-h-40 overflow-auto p-2 text-[10px] bg-surface-100">
                                    ...
                                    <AccordionContent>
                                      <div className="space-y-3 pt-2 text-xs">
                                        ...
                                        <div className="space-y-1">
                                          ...
                                          <p className="rounded bg-white p-2 text-surface-700">{liveSuggestion.debug.question}</p>
                                        </div>
