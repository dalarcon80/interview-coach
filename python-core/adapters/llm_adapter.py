...
# Anthropic models (from API: https://api.anthropic.com/v1/models)
ANTHROPIC_MODELS = [
    # Claude 4.6 Series (Feb 2026)
    {"id": "claude-sonnet-4-6", "name": "Claude Sonnet 4.6 (Latest)", "context_window": 1000000},
    {"id": "claude-opus-4-6", "name": "Claude Opus 4.6", "context_window": 1000000},
    # Claude 4.5 Series
    {"id": "claude-opus-4-5-20251101", "name": "Claude Opus 4.5", "context_window": 200000},
    {"id": "claude-sonnet-4-5-20250929", "name": "Claude Sonnet 4.5", "context_window": 1000000},
    {"id": "claude-haiku-4-5-20251001", "name": "Claude Haiku 4.5", "context_window": 200000},
    # Claude 4.1 Series
    {"id": "claude-opus-4-1-20250805", "name": "Claude Opus 4.1", "context_window": 200000},
    # Claude 4 Series (May 2025)
    {"id": "claude-opus-4-20250514", "name": "Claude Opus 4", "context_window": 200000},
    {"id": "claude-sonnet-4-20250514", "name": "Claude Sonnet 4", "context_window": 1000000},
    # Claude 3 Series
